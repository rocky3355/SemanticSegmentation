...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    conv7 = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, padding='same',
                                     ...
                                     kernel_regularizer=tf.contrib.layers.l2_regularizer(weights))

    upsample0 = tf.layers.conv2d_transpose(conv7, num_classes, 4, strides=(2, 2), padding='same',
                                                  kernel_initializer=tf.random_normal_initializer(stddev=stddev),
                                                  kernel_regularizer=tf.contrib.layers.l2_regularizer(weights))
    ...
    skip0 = tf.add(upsample0, conv4)

    upsample1 = tf.layers.conv2d_transpose(skip0, num_classes, 4, strides=(2, 2), padding='same',
                                                   kernel_initializer=tf.random_normal_initializer(stddev=stddev),
                                                   kernel_regularizer=tf.contrib.layers.l2_regularizer(weights))
    ...
    skip1 = tf.add(upsample1, conv3)

    upsample2 = tf.layers.conv2d_transpose(skip1, num_classes, 16, strides=(8, 8), padding='same',
                                                  kernel_initializer=tf.random_normal_initializer(stddev=stddev),
                                                  kernel_regularizer=tf.contrib.layers.l2_regularizer(weights))
    return upsample2
